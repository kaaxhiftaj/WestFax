...
import com.business.admin.westfax.RegisterActivity;
...
public class InboxAdapter extends RecyclerView.Adapter<InboxAdapter.MyViewHolder> {
    ...
    public InboxAdapter(Context context, ArrayList<ResExpandList> userList) {
        this.mContext = context;
        this.usersList = userList;
    }

    public InboxAdapter(Context context, ArrayList<ResExpandList> userList, ArrayList<ResExpandList> selectedList) {
        this.mContext = context;
        this.usersList = userList;
