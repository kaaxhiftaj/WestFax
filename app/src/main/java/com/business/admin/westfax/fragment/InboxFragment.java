...
public class InboxFragment extends Fragment implements AlertDialogHelper.AlertDialogListener {
    ...
    String unamee, upaasss, uprodid, upinbox;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        upinbox = user.get(UserSessionManager.KEY_INBOUND);
...
//
    ...
    public void getFaxList() {
        ...
        for (int i = 0; i < user_list.size(); i++) {
            ...
            if (user_list.get(i).getMdirection().equals("Inbound")) {
...
//                                    Toast.makeText(getContext(), "Details Page", Toast.LENGTH_SHORT).show();
                            ...
                            @Override
                            public void onItemLongClick(View view, int position) {
                                Log.e("inbox long sizee-->", position+"===>"+multiselect_list.size() + "===" + user_lii.size());
