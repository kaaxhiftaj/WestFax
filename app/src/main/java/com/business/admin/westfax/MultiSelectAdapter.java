...
public class MultiSelectAdapter extends RecyclerView.Adapter<MultiSelectAdapter.MyViewHolder> {
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        public TextView boundtxt, phnnotxt;
        ...
        public MyViewHolder(View view) {
            ...
            ll_listitem=(LinearLayout)view.findViewById(R.id.linitm);
    ...
    public void onBindViewHolder(MyViewHolder holder, int position) {
        ...
        holder.phnnotxt.setText(movie.getName());
        holder.boundtxt.setText(movie.getPosting());
